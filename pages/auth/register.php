...
$karachi_areas = [
  ...
  "Clifton","Saddar","Gulshan-e-Iqbal","Gulistan-e-Johar","North Nazimabad","Nazimabad","Federal B Area","PECHS",
  "Bahria Town","Malir Cantt","Korangi","Landhi","Liaquatabad","Lyari","Shah Faisal Colony"
];
...
<section class="relative min-h-screen py-20 flex items-center justify-center overflow-hidden">
  ...
  <div class="absolute top-0 left-0 w-[520px] h-[520px] bg-[var(--secondary-color)]/10 rounded-full blur-[110px] -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
  <div class="absolute bottom-0 right-0 w-[520px] h-[520px] bg-[var(--btn-color)]/10 rounded-full blur-[110px] translate-x-1/2 translate-y-1/2 pointer-events-none"></div>

  <div class="container relative z-10 mx-auto px-4">
    <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.30)] relative overflow-hidden">
      ...
      <div class="p-8 md:p-12">
        ...
        <form class="space-y-6" method="POST" enctype="multipart/form-data">
          ...
          <!-- Hidden fields -->
          <input type="hidden" name="redirect" value="<?php echo htmlspecialchars($redirectKeyInitial, ENT_QUOTES, 'UTF-8'); ?>">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div class="relative">
                <select class="w-full h-[50px] px-4 bg-[var(--bg-color)] border border-gray-200 rounded-xl text-gray-600 cursor-not-allowed outline-none pointer-events-none appearance-none">
            ...
            <div>
              ...
              <div class="relative">
                <select class="w-full h-[50px] px-4 bg-[var(--bg-color)] border border-gray-200 rounded-xl text-gray-500 cursor-not-allowed outline-none pointer-events-none appearance-none">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select name="area" required
                ...
                <option value="" disabled <?php echo empty($area) ? 'selected' : ''; ?>>Select Area in Karachi</option>
          ...
          <?php
            ...
            $loginQuery = [];
            if (!empty($redirectKeyInitial)) $loginQuery['redirect'] = $redirectKeyInitial;
            if (!empty($jobId)) $loginQuery['job_id'] = $jobId;

            $loginUrl = 'login.php';
            if (!empty($loginQuery)) $loginUrl .= '?' . http_build_query($loginQuery);
          ?>
